...
DATABASE = '/home/pi/Desktop/Temperature_Humidity_Displayer/TempLogger/temp_humdLog.db'
...
def display():
	graph = False;
	if request.method == 'POST':
		if request.form['submit'] == 'Display The Searched Data':
	...
	if request.method == 'POST':
		if request.form['submit'] == " Graph The Seached Data  ":
			date = request.form['date']
			...
			with open('temp_humdLog.csv','wb') as out_csv_file:
